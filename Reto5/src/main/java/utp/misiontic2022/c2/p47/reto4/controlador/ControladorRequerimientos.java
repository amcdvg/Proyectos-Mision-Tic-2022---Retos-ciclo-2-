...
public class ControladorRequerimientos {
   ...
   // TransformarDao dao = new TransformarDao();
    ...
    public ArrayList<Lider> consultarRequerimiento1(String sql1) throws SQLException {
        LiderDao dao = new LiderDao();
    ...
    public ArrayList<Lider> consultarRequerimiento1(String consulta, String string) {
        return null;
    }
}
